...
$sub_folder = 'sm18/';//If app installed in subfolder, place here.  name of folder, no leading or trailing forward or backslash
...
define('SUPPORT_EMAIL', 'Xing.Li2@SeattleColleges.edu'); # Email of site support
define('PREFIX', 'sm18_'); #Adds uniqueness to DB table names.  Limits hackability, naming collisions.  In WordPress the prefix is wp_
...
$nav1['feeds/index.php'] = "Feeds~for final project";
